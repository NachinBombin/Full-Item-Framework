-- ============================================================
--  NPC Flashbang Throw  |  npc_flashbang_throw_menu.lua
...
-- ============================================================
hook.Add("AddToolMenuCategories", "NPCFlashbangThrow_AddCategory", function()
...
--  Build the panel
-- ============================================================
hook.Add("PopulateToolMenu", "NPCFlashbangThrow_PopulateMenu", function()
    spawnmenu.AddToolMenuOption(
        "Options",                        -- tab  (the Options tab)
        ADDON_CATEGORY,                   -- category
        "npc_flashbang_throw_settings",   -- unique class key
        "NPC Flashbang Throw",            -- display name
        "",                               -- icon (none needed)
        "",                               -- description tooltip
        function(panel)
            ...
            panel:AddControl("Header", {
                Description = "NPC Flashbang Throw Settings",
                Height      = "40",
            })

            panel:CheckBox("Enable NPC Flashbang Throws", "npc_flashbang_throw_enabled")
            panel:ControlHelp("  Master on/off switch for the entire addon.")

            panel:CheckBox("Debug Announce in Console", "npc_flashbang_throw_announce")
            ...
            panel:NumSlider("Throw Chance",
                "npc_flashbang_throw_chance", 0, 1, 2)
            panel:ControlHelp("  Probability (0.00 – 1.00) that an eligible NPC throws\n  a flashbang each time it is checked.  Default: 0.20")

            panel:NumSlider("Check Interval (seconds)",
                "npc_flashbang_throw_interval", 1, 30, 0)
            ...
            panel:NumSlider("Throw Cooldown (seconds)",
                "npc_flashbang_throw_cooldown", 1, 60, 0)
            ...
            panel:NumSlider("Launch Speed (units/s)",
                "npc_flashbang_throw_speed", 100, 1500, 0)
            panel:ControlHelp("  How fast the flashbang is thrown.  Default: 700")

            panel:NumSlider("Arc Factor",
                "npc_flashbang_throw_arc", 0, 1, 2)
            panel:ControlHelp("  Upward lob strength.\n  0.00 = nearly flat,  1.00 = very high arc.  Default: 0.25")

            panel:NumSlider("Spawn Offset (units)",
                "npc_flashbang_throw_spawn_dist", 20, 150, 0)
            ...
            panel:CheckBox("Apply Random Spin to Grenade", "npc_flashbang_throw_spin")
            ...
            panel:NumSlider("Max Distance",
                "npc_flashbang_throw_max_dist", 200, 6000, 0)
            ...
            panel:NumSlider("Min Distance",
                "npc_flashbang_throw_min_dist", 0, 500, 0)
            ...
            --  Info footer
            -- ------------------------------------------------
            panel:ControlHelp("  Changes take effect immediately.\n  Requires the ent_flashbang entity.\n  Blinding credit is assigned to the throwing NPC.")
